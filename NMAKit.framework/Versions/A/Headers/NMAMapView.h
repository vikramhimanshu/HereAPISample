 ...
 *
 * \sa NMAMapView::setGeoCenter:zoomLevel:withAnimation:
 */
...
typedef NS_ENUM(NSUInteger, NMAMapPPI) {
    /** \brief Default PPI, suitable for mobile devices. */
    NMAMapPPILow,
    /** \brief High PPI. */
    NMAMapPPIHigh,
 ...
 * <ul>
 * <li>setting the map center (with animation), for exmaple with NMAMapView::setGeoCenter:zoomLevel:withAnimation: or
 * NMAMapView::setGeoCenter:withAnimation:</li>
 * <li>setting the map zoom level (with animation). E.g. with NMAMapView::setZoomLevel:withAnimation:</li></ul>
 */
 ...
 *
 * \note Values must be in the range [NMAMapViewMinimumZoomLevel,
...
/**
 * \brief The copyright logo position for the %NMAMapView.
 *
...
/**
 * \brief The distance in points that the copyright logo will be from the top or
...
/**
 * \brief The distance in points that the copyright logo will be from the left or
 ...
 *
 * \note If it fails, the map display language is set to English.
 */
 ...
 *
 * \param locale
 *        The NSLocale as described in <a
 *        href="https://developer.apple.com/library/mac/documentation/Cocoa/Reference/Foundation/Classes/NSLocale_Class/</a>.
