 ...
 * @{
 * \class NMAGeoBoundingBox NMAGeoBoundingBox.h "NMAGeoBoundingBox.h"
 *
 * \brief Represents a bounding box that defines a rectangular area in a
 ...
 * the longitude of the bottom-right corner).</p>
 * <p>
 ...
 * bounding box with a width of 0 degrees.</p>
 */
 ...
 * in degrees.
 *
 * \note If the specified values produce a box with top edge latitude > 90 or bottom edge latitude < -90,
...
/*!
 * \brief Constructs a %NMAGeoBoundingBox which contains all coordinates in an array.
 *
 * <p>
 ...
 * \return The %NMAGeoBoundingBox
 */
+ (instancetype)geoBoundingBoxContainingGeoCoordinates:(NSArray<NMAGeoCoordinates *> *)coordinates
NS_SWIFT_NAME(init(containingCoordinates:));

/*!
 * \brief Constructs a %NMAGeoBoundingBox which contains all bounding boxes in an array.
 *
 * <p>
 * The constructed NMAGeoBoundingBox will be the smallest possible box which contains all
 ...
 * \return The %NMAGeoBoundingBox
 */
+ (instancetype)geoBoundingBoxContainingGeoBoundingBoxes:(NSArray<NMAGeoBoundingBox *> *)boundingBoxes
 ...
 *
 * \note The interection may have zero area.
 *
